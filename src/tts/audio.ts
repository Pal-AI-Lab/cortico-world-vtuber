...
export function decodePcm16ToDecoded(pcm: Uint8Array, sampleRate: number, channels: 1 | 2): DecodedWav {
 ...
 */
export function decodeAudioBytes(bytes: Uint8Array, opts: DecodeAudioOptions): DecodedWav {
...
export function decodedToPcm16(decoded: DecodedWav): Uint8Array {
 ...
 */
export function decodedToWav(decoded: DecodedWav): Uint8Array {
